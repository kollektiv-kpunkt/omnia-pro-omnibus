...
if (file_exists(__DIR__ . "/../frontend/public/img/kandis/" . strtolower($kandi["vorname"]) . "-" . strtolower($kandi["nachname"]) . ".jpg")) {
    rename(__DIR__ . "/../frontend/public/img/kandis/" . strtolower($kandi["vorname"]) . "-" . strtolower($kandi["nachname"]) . ".jpg", __DIR__ . "/../frontend/public/img/kandis/" . $kandi["id"] . ".jpg");
} elseif (file_exists(__DIR__ . "/../frontend/public/img/kandis/" . $kandi["id"] . ".jpg")) {
} else {
    echo "File not found: " . __DIR__ . "/../frontend/public/img/kandis/" . strtolower($kandi["vorname"]) . "-" . strtolower($kandi["nachname"]) . ".jpg" . PHP_EOL;
}
